...
var LBDService = /*#__PURE__*/function () {
  ...
  _createClass(LBDService, [{
    ...
    value: function () {
      var _removeProjectRegistry = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(url) {
        var q0;
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.prev = 0;
                q0 = "DELETE {<".concat(this.session.info.webId, "> <").concat(_lbd["default"].hasProjectRegistry, "> <").concat(url, "> .}\n      WHERE {<").concat(this.session.info.webId, "> <").concat(_lbd["default"].hasProjectRegistry, "> ?reg .}");
                _context6.next = 4;
      ...
      function removeProjectRegistry(_x5) {
