        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 48:
                referenceMeta = new _LbdDataset.LbdDataset(this.session, referenceContainerUrl);
                _context3.next = 51;
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                theDataset = new _LbdDataset.LbdDataset(this.session, datasetUrl);
                _context11.next = 9;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                ds = new _LbdDataset.LbdDataset(this.session, datasetUrl);
                _context12.next = 4;
                return ds["delete"]();
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                ...
                ref = new _LbdConcept.LbdConcept(this.session, referenceRegistry);
                _context15.next = 5;
          ...
          while (1) {
            switch (_context18.prev = _context18.next) {
              ...
              case 55:
                subject = (0, _functions.extract)(this.data, this.localProject);
                referenceRegistry = subject[_lbds["default"].hasReferenceRegistry][0]["@id"];
                theConcept = new _LbdConcept.LbdConcept(this.session, referenceRegistry);
