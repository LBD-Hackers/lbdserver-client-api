          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return this.dataService.sparqlUpdate(this.distribution, q0);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                referenceUrl = this.distribution + "#" + referenceId;
                identifierId = (0, _uuid.v4)();
                identifierUrl = this.distribution + "#" + identifierId;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                ...
                _context4.next = 7;
                return this.dataService.sparqlUpdate(this.distribution, q1);
