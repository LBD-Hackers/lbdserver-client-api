...
var LbdDistribution = /*#__PURE__*/function () {
  function LbdDistribution(session, url, dataset) {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 11:
                throw new Error("\"Could not find contentType in dataset ".concat(this.dataset.url));
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                makePublic = _args6.length > 3 ? _args6[3] : undefined;
