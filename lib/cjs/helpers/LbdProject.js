  ...
  _createClass(LbdProject, [{
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.next = 3;
                return myEngine.query("SELECT ?proj WHERE {<".concat(this.accessPoint, "> <").concat(_lbd["default"].aggregates, "> ?proj}"), {
    ...
    value: function () {
      var _getAllPartialProjects = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
        var myEngine, q, results, _yield$myEngine$resul, data, asJson, partials;
    ...
    value: function () {
      var _getAllDatasetUrls = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16(options) {
        var myEngine, subject, sources, partials, _iterator2, _step2, p, dsReg, q, results, _yield$myEngine$resul2, data, parsed;
        ...
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 35:
                _yield$myEngine$resul2 = _context16.sent;
                data = _yield$myEngine$resul2.data;
