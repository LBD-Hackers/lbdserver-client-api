...
var LbdDataset = /*#__PURE__*/function () {
  ...
  _createClass(LbdDataset, [{
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                dist = new _LbdDistribution["default"](this.session, distributionUrl);
                _context6.next = 7;
    ...
    value: function () {
      var _getDistributions = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
        var dataset, distributionUrls, distributions, _iterator, _step, url, dist;

        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                dataset = (0, _functions.extract)(this.data, this.url);
                distributionUrls = dataset[_vocabCommonRdf.DCAT.distribution].map(function (i) {
                  return i["@id"];
                });
                distributions = [];
                _iterator = _createForOfIteratorHelper(distributionUrls);

                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    url = _step.value;
                    dist = new _LbdDistribution["default"](this.session, url);
      ...
      function getDistributions() {
        return _getDistributions.apply(this, arguments);
      }
