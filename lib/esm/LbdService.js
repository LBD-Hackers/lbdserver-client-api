    ...
    return new Promise(async (resolve, reject) => {
      ...
      CONSTRUCT {
       ...
       ?s2 <${_vocabCommonRdf.OWL.sameAs}> ?s1 .
          ...
          ?concept1 <${_lbds.default.hasReference}>/<${_lbds.default.hasIdentifier}>/<https://w3id.org/lbdserver#value> ?s1 .
          ?concept2 <${_lbds.default.hasReference}>/<${_lbds.default.hasIdentifier}>/<https://w3id.org/lbdserver#value> ?s2 .
