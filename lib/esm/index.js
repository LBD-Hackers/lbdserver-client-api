...
(function (_LBDserver) {
  const LbdService = _LBDserver.LbdService = _LbdService.default;
  const LbdProject = _LBDserver.LbdProject = _LbdProject.default;
  const LbdDataset = _LBDserver.LbdDataset = _LbdDataset.default;
  const LbdConcept = _LBDserver.LbdConcept = _LbdConcept.default;
  const LbdDistribution = _LBDserver.LbdDistribution = _LbdDistribution.default;
  const vocabulary = _LBDserver.vocabulary = {
    LBDS: _lbds.default
  };
