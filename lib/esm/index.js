...
(function (_Consolid) {
  const LBDService = _Consolid.LBDService = _LbdService.default;
  const LbdProject = _Consolid.LbdProject = _LbdProject.default;
  const LbdDataset = _Consolid.LbdDataset = _LbdDataset.default;
  const LbdDistribution = _Consolid.LbdDistribution = _LbdDistribution.default;
